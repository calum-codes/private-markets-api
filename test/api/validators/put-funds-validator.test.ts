...
import { putFundsValidator } from "../../../src/api/validators/put-funds";
...
describe("postFundsValidator", () => {
  ...
  describe("id", () => {
    it("should throw an ApiValidationError if id is not provided", () => {
      expect(() =>
        putFundsValidator.validate({
          body: JSON.stringify({
            id: undefined,
      ...
      ).toThrow(new ApiValidationError("body.id is a required field"));
    });

    it("should throw an ApiValidationError if id is not a UUID", () => {
      expect(() =>
        putFundsValidator.validate({
          body: JSON.stringify({
            id: "abc",
      ...
      ).toThrow(new ApiValidationError("body.id must be a valid UUID"));
    });
  });
